...
interface SpInterface
{
    ...
    // the individual files are loaded with getIdp($filename)
    ...
    public function login(string $idpFilename, int $assertID, int $attrID, $level = 1, string $redirectTo = null, $shouldRedirect = true, $isPost = false);
